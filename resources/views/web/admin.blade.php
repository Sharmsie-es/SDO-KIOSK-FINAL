...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('web/css/adminstyle.css') }}">
        ...
        <div class="row">
            <div class="col-md-2 sidebar">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><input type="checkbox"> Organizational Chart</li>
                    <li><input type="checkbox"> Citizen Charter</li>
                </ul>
            </div>
            <div class="col-md-10 main">
                <div class="header d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="{{ url('/homepage') }}" class="btn btn-primary active">Go Back</a>
                </div>
                ...
                <div class="upload-container mt-5">
                    <form action="{{ url('/upload-background') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
